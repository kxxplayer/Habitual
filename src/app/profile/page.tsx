    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4 text-center">
        <Card className="w-full max-w-md shadow-xl">
          <CardHeader>
            <CardTitle>Profile Access Denied</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="rounded-md border border-dashed border-input bg-input/30 p-3 text-xs text-muted-foreground">
              For security reasons, your password cannot be displayed. To change your password, please use a "Forgot Password" feature if available on the login page (not yet implemented).
            </div>
          </div>
