...
import type { CreateHabitFormData, WeekDay } from '../../types';
...
const CreateHabitDialog: FC<CreateHabitDialogProps> = ({
  ...
  const handleAIHabitGeneration = async () => {
    ...
    try {
      ...
      if (result.durationHours != null) form.setValue('durationHours', result.durationHours);
      if (result.durationMinutes != null) form.setValue('durationMinutes', result.durationMinutes);
